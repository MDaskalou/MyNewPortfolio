...
const myProjectsData = [
    {
        ...
        description:
            "One year ago, I began my studies to become a software developer. " +
    ...
    },
    {
        ...
        description:
            "This project is for a dance school called Fuego Dance School, which focuses on bachata – " +
            "a couple dance from the Dominican Republic. The aim was to create a user-friendly website " +
    ...
    },
    {
        ...
        description:
            "This was our final assignment before the summer break — a full stack project built by a group of four." +
            " We created a simple budget management app where users can register, log in, and manage their personal finances. " +
